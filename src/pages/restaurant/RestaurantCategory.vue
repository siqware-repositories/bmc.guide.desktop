...
<script>
    export default {
        ...
        computed: {
            getCategory(){
                return this.$store.getters['restaurant_category/getRestaurantCategory']
            }
        },
        async created() {
        },
        methods: {
            ...
            destroyRestaurantCategory(id) {
                ...
                self.$q
                    ...
                    .onOk(() => {
                        self.$store.dispatch("restaurant_category/deleteRestaurantCategory", id).then(function () {
                            self.$store.dispatch("restaurant_category/indexRestaurantCategory").then(function () {
                                self.$q.notify({
                                    message: "Was deleted",
                                    position: "top",
                                    color: "negative"
